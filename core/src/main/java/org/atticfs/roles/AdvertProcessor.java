...
/**
 * Processes the receipt of adverts.
 * The ChannelData should be modified if there is anything to send back,
 * or the outcome needs setting.
 * <p/>
 * The adverts are just the RequestData of the ChannelData extracted during
 * handling of the message.
 *
 * 
 */
public interface AdvertProcessor extends ServiceRole {
