...
public class PointerRequestHandler extends AbstractRequestHandler implements Authenticating {
    ...
    public PointerRequestHandler(String path, DataPointerStore store, AdvertProcessor advertProcessor) {
        this.path = path;
        this.store = store;
        this.advertProcessor = advertProcessor;
    }

    public PointerRequestHandler(DataPointerStore store, AdvertProcessor advertProcessor) {
